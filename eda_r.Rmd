...
```{r}
#CorrelaciÛn entre varoables
cor(data$EstimatedSalary,as.numeric(data$Exited))
```
**InterpretaciÛn**
En este caso, el valor de 0.0121 indica una correlaciÛn muy cercana a cero, es decir,  sugiere una relaciÛn lineal dÈbil o pr·cticamente inexistente entre las dos variables.
